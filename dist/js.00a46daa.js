...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/babel-polyfill/node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"js/views/base.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.clearSimilarRecipe = exports.clearRecipeList = exports.spinner = exports.elements = exports.apiKey = void 0;
var apiKey = 'c911c7a6e36c4e568e9996870383ab49';
...
var spinner = function spinner(position) {
  position.innerHTML = '';
...
var clearRecipeList = function clearRecipeList() {
  elements.recipeList.innerHTML = '';
  elements.btnsRecipeList.innerHTML = '';
};

exports.clearRecipeList = clearRecipeList;

var clearSimilarRecipe = function clearSimilarRecipe() {
  elements.similarRecipesHeading.innerHTML = '';
  elements.similarRecipes.innerHTML = '';
};

exports.clearSimilarRecipe = clearSimilarRecipe;
...
exports.renderListAutocomplete = exports.renderListRecipe = exports.limitRecipeTitle = void 0;
...
var createButton = function createButton(page, type, position) {
  return "\n        <button type=\"button\" class=\"btn btn-success btn-sm btn-inline ".concat(position, "\" data-goto=").concat(type === 'next' ? page + 1 : page - 1, ">\n            ").concat(type, "\n        </button>\n    ");
};
...
var renderButtons = function renderButtons(page, numResults, resPerPage) {
  ...
  if (page === 1 && pages > 1) {
    ...
    button = "\n            ".concat(createButton(page, 'prev', 'float-left'), "\n            ").concat(createButton(page, 'next', 'float-right'), "\n        ");
  ...
  _base.elements.btnsRecipeList.insertAdjacentHTML('beforeend', button);
};

var renderListRecipe = function renderListRecipe(results, baseUri) {
  var page = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1;
  var resPerPage = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 10;
  var start = (page - 1) * resPerPage;
  var end = page * resPerPage;

  if (results) {
    (0, _base.clearRecipeList)();
    results.slice(start, end).forEach(function (item) {
      var html = "\n                <a href=\"#".concat(item.id, "\" class=\"list-group-item list-group-item-action recipe-list-item\">\n                    <img src=\"").concat(baseUri + item.image, "\" class=\"list-image\" alt=\"").concat(item.title, "\">\n                    ").concat(limitRecipeTitle(item.title), "\n                </a>\n            ");

      _base.elements.recipeList.insertAdjacentHTML('beforeend', html);
    });
    renderButtons(page, results.length, resPerPage);
  }
};

exports.renderListRecipe = renderListRecipe;

var renderListAutocomplete = function renderListAutocomplete(data) {
  var val = _base.elements.searchValue.value;
  _base.elements.autocompleteList.innerHTML = '';

  if (val) {
    data.forEach(function (item) {
      var html = "\n                <a class=\"autocomplete-list-item list-group-item list-group-item-action\">".concat(item.title, "</a>\n            ");

      _base.elements.autocompleteList.insertAdjacentHTML('beforeend', html);
...
exports.renderListAutocomplete = renderListAutocomplete;

var getAutocompleteList = function getAutocompleteList(list) {
  return list.forEach(_index.setAutocompleteRecipe);
};
},{"./base":"js/views/base.js","../index":"js/index.js"}],"js/models/Search.js":[function(require,module,exports) {
"use strict";
...
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","../views/searchView":"js/views/searchView.js","../views/base":"js/views/base.js"}],"js/models/Recipe.js":[function(require,module,exports) {
"use strict";
...
var Recipe = /*#__PURE__*/function () {
  ...
  _createClass(Recipe, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return fetch("https://api.spoonacular.com/recipes/".concat(this.id, "/information?apiKey=").concat(_base.apiKey, "&includeNutrition=false"));
    ...
    key: "getSimilarRecipe",
    value: function () {
      var _getSimilarRecipe = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var res, data;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return fetch("https://api.spoonacular.com/recipes/".concat(this.id, "/similar?apiKey=").concat(_base.apiKey, "&number=3"));
      ...
      function getSimilarRecipe() {
        return _getSimilarRecipe.apply(this, arguments);
      }

      return getSimilarRecipe;
    }()
  }]);
...
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","../views/base":"js/views/base.js"}],"js/models/Likes.js":[function(require,module,exports) {
"use strict";
...
var Likes = /*#__PURE__*/function () {
  ...
  _createClass(Likes, [{
    key: "addLikes",
    value: function addLikes(obj) {
      this.likes.push(obj);
      this.setStorage();
    }
  }, {
    key: "deleteLike",
    value: function deleteLike(e) {
      var id = parseInt(e.target.parentElement.getAttribute('href').slice(1), 10);
    ...
    key: "likesCounter",
    value: function likesCounter(position) {
    ...
    value: function getStorage() {
      var storage = localStorage.getItem('likes') ? JSON.parse(localStorage.getItem('likes')) : [];
      this.likes = storage;
    }
  }]);
...
exports.selectedList = exports.renderSimilarRecipe = exports.renderRecipe = void 0;

var _base = require("./base");

var renderRecipe = function renderRecipe(recipe, isLiked) {
  _base.elements.recipe.innerHTML = '';
  var html = "\n        <h4 class=\"text-center text-success\">".concat(recipe.title, "</h4>\n        <div class=\"main-image mb-3 mt-4\">\n            <img src=\"").concat(recipe.img, "\" alt=\"").concat(recipe.title, "\">\n        </div>\n\n        <h5>Ingredients:</h5>\n        <ul class=\"list-group mb-3\">\n            ").concat(recipe.ingredients.map(function (ing) {
    return "\n                <li class=\"list-group-item\">".concat(ing.original, "</li>\n            ");
  }).join(''), "\n        </ul>\n\n        <h5>Instructions:</h5>\n        <ul class=\"list-group mb-3\">\n            <li class=\"list-group-item\">").concat(recipe.instructions, "</li>\n        </ul>\n\n        <button type=\"button\" class=\"btn btn-success likes-btn\" ").concat(isLiked ? 'disabled' : '', " data-recipeId=").concat(recipe.recipeId, ">\n            ").concat(isLiked ? 'added in likes' : 'add to favorites', "  \n        </button>\n    ");

  _base.elements.recipe.insertAdjacentHTML('beforeend', html);
};

exports.renderRecipe = renderRecipe;

var renderSimilarRecipe = function renderSimilarRecipe(similarRecipe) {
  (0, _base.clearSimilarRecipe)();

  _base.elements.similarRecipesHeading.insertAdjacentHTML('beforeend', '<h5>Similar Recipes:</h5>');

  similarRecipe.forEach(function (item) {
    var html = "\n            <a href=\"#".concat(item.id, "\" class=\"col-sm-3 text-decoration-none mr-1\">\n                <div class=\"card border border-success\">\n                    <div class=\"card-body\">\n                        <h5 class=\"card-text text-body\">").concat(item.title, "</h5>\n                        <p class=\"card-text text-body\">servings: ").concat(item.servings, "</p>\n                        <p class=\"card-text text-body\">ready in minutes: ").concat(item.readyInMinutes, "</p>\n                    </div>\n                </div>\n            </a>\n        ");

    _base.elements.similarRecipes.insertAdjacentHTML('beforeend', html);
  });
};

exports.renderSimilarRecipe = renderSimilarRecipe;

var selectedList = function selectedList() {
  var recipeListItem = document.querySelectorAll('.recipe-list-item');
  recipeListItem.forEach(function (list) {
    list.addEventListener('click', function (e) {
      var listImage = e.target.closest('.list-image');
      recipeListItem.forEach(function (item) {
        return item.classList.remove('active', 'bg-success');
      });
...
},{"./base":"js/views/base.js"}],"js/views/likesView.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteLike = exports.renderLikes = void 0;

var _base = require("./base");

var _searchView = require("./searchView");

var renderLikes = function renderLikes(likesObj) {
  _base.elements.likesDropdown.innerHTML = '';
  likesObj.forEach(function (item) {
    var html = "\n            <a href=\"#".concat(item.id, "\" class=\"list-group-item list-group-item-action\">\n                <img class=\"list-image\" src=\"").concat(item.img, "\" alt=\"").concat(item.title, "\">\n                ").concat((0, _searchView.limitRecipeTitle)(item.title, 20), "\n                <span class=\"badge badge-success btn-delete-likes\">X</span>\n            </a>\n        ");

    _base.elements.likesDropdown.insertAdjacentHTML('beforeend', html);
  });
};

exports.renderLikes = renderLikes;

var deleteLike = function deleteLike(e) {
...
},{"./base":"js/views/base.js","./searchView":"js/views/searchView.js"}],"js/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setAutocompleteRecipe = void 0;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            query = _base.elements.searchValue.value.trim();
            ...
            (0, _base.clearRecipeList)();
            (0, _base.spinner)(_base.elements.recipeList);
            _context.prev = 6;
            _context.next = 9;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 3;
            _context2.next = 6;
            return state.search.autocompleteSearch();
...
var setAutocompleteRecipe = function setAutocompleteRecipe(listItem) {
  listItem.addEventListener('click', function (e) {
    _base.elements.searchValue.value = e.target.textContent;

    _base.elements.btnSubmit.click();
  });
};

exports.setAutocompleteRecipe = setAutocompleteRecipe;
document.addEventListener('click', function (e) {
  if (!_base.elements.autocompleteList.contains(e.target)) {
    _base.elements.autocompleteList.innerHTML = '';
  }
});

_base.elements.btnsRecipeList.addEventListener('click', function (e) {
  var btn = e.target;
...
_base.elements.searchForm.addEventListener('submit', controlSearch);

_base.elements.searchForm.addEventListener('input', autocomplete); // RECIPE CONTROLLER
...
var controlRecipe = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            id = parseInt(e.target.location.hash.replace('#', ''), 10);
            state.recipe = new _Recipe.default(id);
            (0, _base.spinner)(_base.elements.recipe);
            _context3.prev = 3;
            _context3.next = 6;
          ...
          case 6:
            _context3.next = 8;
            return state.recipe.getSimilarRecipe();
  ...
  return function controlRecipe(_x2) {
    return _ref3.apply(this, arguments);
  };
}();

window.addEventListener('hashchange', controlRecipe); // LIKES CONTROLLER

var controlLikes = function controlLikes(e) {
  if (!state.likes) {
    state.likes = new _Likes.default();
  }
  ...
  if (e.target.classList.contains('likes-btn')) {
    ...
    state.likes.isLiked(state.likes.likes.map(function (el) {
      return el.id;
    }));
  ...
  state.likes.likesCounter(_base.elements.likesCounter);
};

var deleteLikeItem = function deleteLikeItem(e) {
...
var persistStorage = function persistStorage() {
  state.likes = new _Likes.default();
...
_base.elements.recipe.addEventListener('click', controlLikes);

_base.elements.likesDropdown.addEventListener('click', deleteLikeItem);

window.addEventListener('load', persistStorage);
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","./models/Search":"js/models/Search.js","./models/Recipe":"js/models/Recipe.js","./models/Likes":"js/models/Likes.js","./views/searchView":"js/views/searchView.js","./views/recipeView":"js/views/recipeView.js","./views/likesView":"js/views/likesView.js","./views/base":"js/views/base.js"}],"../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
